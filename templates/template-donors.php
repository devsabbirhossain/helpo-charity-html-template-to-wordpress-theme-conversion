...
?>
			<main class="main">
				<section class="promo-primary">
					<picture>
						<source srcset="<?php echo get_theme_file_uri(); ?>/assets/img/donors.jpg" media="(min-width: 992px)"/><img class="img--bg" src="<?php echo get_theme_file_uri(); ?>/assets/img/donors.jpg" alt="img"/>
					</picture>
				...
				<!-- donors inner start-->
				<section class="section donors-inner"><img class="donors-inner__bg" src="<?php echo get_theme_file_uri(); ?>/assets/img/donors_inner.png" alt="img"/>
					<div class="container">
							...
							<div class="col-12">
								...
								<div class="slider-holder">
									<div class="donors-slider donors-slider--style-2 offset-margin">
										...
										<div class="donors-slider__item">
											<div class="donors-slider__img"><img src="<?php echo get_theme_file_uri(); ?>/assets/img/donor_5.png" alt="donor"/></div>
										</div>
										<div class="donors-slider__item">
											<div class="donors-slider__img"><img src="<?php echo get_theme_file_uri(); ?>/assets/img/donor_6.png" alt="donor"/></div>
										</div>
										<div class="donors-slider__item">
											<div class="donors-slider__img"><img src="<?php echo get_theme_file_uri(); ?>/assets/img/donor_7.png" alt="donor"/></div>
										</div>
										<div class="donors-slider__item">
											<div class="donors-slider__img"><img src="<?php echo get_theme_file_uri(); ?>/assets/img/donor_8.png" alt="donor"/></div>
										</div>
									</div>
								</div>
								<!-- donors slider end-->
				...
				<section class="section info no-padding-top">
					<div class="container">
						...
						<div class="row">
							<div class="col-12">
								<div class="info__img"><img class="img--layout" src="<?php echo get_theme_file_uri(); ?>/assets/img/info_img-layout.png" alt="img"/><img src="<?php echo get_theme_file_uri(); ?>/assets/img/info_img.png" alt="img"/></div>
							</div>
						</div>
					</div>
				</section>
				...
				<section class="section no-padding-top">
					<div class="container">
						<div class="row">
							<div class="col-12">
								<div class="info-banner"><img class="img--layout" src="<?php echo get_theme_file_uri(); ?>/assets/img/info-banner_layout.png" alt="img"/>
									<div class="row margin-bottom">
										<div class="col-12">
									...
									<div class="row align-items-center">
										<div class="col-lg-5">
											<div class="info-banner__img"><img src="<?php echo get_theme_file_uri(); ?>/assets/img/info-banner_img.png" alt="img"/></div>
										</div>
										<div class="col-lg-6">
				...
				<!-- info banner end-->
				<!-- text section start-->
				<section class="section text-section text-section--style-2"><img class="text-section__bg-left" src="<?php echo get_theme_file_uri(); ?>/assets/img/text-section_left.png" alt="img"/><img class="text-section__bg-right" src="<?php echo get_theme_file_uri(); ?>/assets/img/text-section_right.png" alt="img"/>
					<div class="container">
						<div class="row">
